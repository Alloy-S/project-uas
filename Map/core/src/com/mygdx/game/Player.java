...
public class Player {
    ...
    public Player(TextureRegion textureRegionUp, TextureRegion textureRegionDown, TextureRegion textureRegionLeft, TextureRegion textureRegionRight, Sound stepSound) {
